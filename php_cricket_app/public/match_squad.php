...
$result = $id === '' ? ['ok' => false, 'error' => 'Provide ?id=<match_id>', 'data' => [], 'raw' => null] : $client->getMatchSquad($id);
...
<head>
    ...
    <title>Fantasy Match Squad API</title>
...
<body>
<h1>PHP Code Fantasy Match Squad API</h1>
