...
$result = $id === '' ? ['ok' => false, 'error' => 'Provide ?id=<match_id>', 'data' => [], 'raw' => null] : $client->getMatchPoints($id);
...
<head>
    ...
    <title>Fantasy Match Points API</title>
...
<body>
<h1>PHP Code Fantasy Match Points API</h1>
