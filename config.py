...
class Config:
    ...
    CRICKET_DATA_API_KEY = "406661-0908ae31ec69"
    ...
    CRICBUZZ_RAPIDAPI_KEY = os.environ.get('5ec7de7440jsnab9383687aa0') or None
    CRICBUZZ_RAPIDAPI_HOST = os.environ.get('5ec7de79a0msh87aa0') or 'cricbuzz-cricket.p.rapidapi.com'
    CRICBUZZ_BASE_URL = os.environ.get('CRICBUZZ_BASE_URL') or 'https://cricbuzz-cricket.p.rapidapi.com'
    
    # YouTube API Configuration
    YOUTUBE_API_KEY = "AIzaS7PIkM"
